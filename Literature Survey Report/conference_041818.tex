...
\author{\IEEEauthorblockN{\textsuperscript{st} Adithi Satish}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{PES University}\\
Bangalore, India \\
adithisatish@pesu.pes.edu}
\and
\IEEEauthorblockN{\textsuperscript{nd} Raksha Ramesh}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{PES University}\\
Bangalore, India \\
raksharamesh@pesu.pes.edu}
\and
\IEEEauthorblockN{3\textsuperscript{rd} Shriya B Shankar}
\IEEEauthorblockA{\textit{Department of Computer Science and Engineering} \\
\textit{PES University}\\
Bangalore, India \\
...
\begin{abstract}
The primary goal of this project is to delve deep 
...
Using ubiquitous methods of statistical analytics like multiple linear regression
and 
\end{abstract}
